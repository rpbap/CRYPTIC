...
This tool uses Blastn to retrieve Cryptosporidium GP60 sequences from the genomes and compare to the reference database provided. Best hits would be kept and the equivalent GP60 type will be stored in typing_log.csv
